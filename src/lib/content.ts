...
export const siteContent = {
  ...
  portfolio: {
    tagline: "Portfolio",
    headline: "숙소 타이틀",
    description: "설명설명설명설명설명설명설명설명설명설명설명",
    ctaText: "모든 스테이 보기",
    items: [
      {
        id: 1,
        ...
        location: "제주시 애월읍",
        category: "펜션",
        description: "제주의 자연을 담은 감성적인 공간으로 재탄생한 스테이입니다.",
        image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800",
        link: "/story/jeju-stay",
      },
      {
        id: 2,
        title: "서울 루프탑 스튜디오",
        location: "서울 마포구",
        category: "게스트하우스",
        description: "도심 속 루프탑에서 특별한 경험을 선사하는 스튜디오입니다.",
        image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800",
        link: "/story/seoul-rooftop",
      },
      {
        id: 3,
        title: "부산 오션뷰 빌라",
        location: "부산 해운대구",
        category: "풀빌라",
        description: "해운대 바다가 한눈에 보이는 프라이빗 풀빌라입니다.",
        image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800",
        link: "/story/busan-villa",
      },
      {
        id: 4,
        title: "강릉 포레스트 하우스",
        location: "강릉시 주문진읍",
        category: "단독주택",
        description: "소나무 숲 속에 자리한 조용한 힐링 스테이입니다.",
        image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800",
        link: "/story/gangneung-forest",
      },
    ],
  },
